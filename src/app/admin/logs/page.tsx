          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
                      ...
                      logs.map((l) => (
                        <tr key={l.id} className="hover:bg-muted/30">
                          ...
                          <td className="px-4 py-3">
                            <span className="inline-flex px-2 py-0.5 rounded text-xs bg-neutral-100 text-neutral-900">
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-4">
                <Button asChild variant="outline" size="sm" disabled={page <= 1} className="border-neutral-200 hover:bg-neutral-50">
                ...
                <Button asChild variant="outline" size="sm" disabled={page >= totalPages} className="border-neutral-200 hover:bg-neutral-50">
                  <Link href={goPage(page + 1)}>
