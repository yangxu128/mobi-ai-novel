...
const FAQS: Array<{ q: string; a: string }> = [
  {
    q: "免费版能用什么？",
    a: "免费版包含 1 个项目、三种创作模式与知识库，每日签到领 50 积分（≈20 万 tokens），永久免费。付费套餐按月订阅：基础版 39 元/月 1000 积分（≈400 万 tokens）、标准版 99 元/月 2000 积分（≈800 万 tokens）、专业版 189 元/月 4000 积分（≈1600 万 tokens）、旗舰版 299 元/月 7000 积分（≈2800 万 tokens）。",
  },
  {
    q: "三种创作模式有什么区别？",
  ...
  {
    q: "积分用完了怎么办？",
    a: "积分按 AI 实际 token 用量扣减（1 积分 = 4000 tokens）：月度积分每月 1 日重置，签到积分长期有效。积攒的签到积分用完时，可升级套餐获取每月额度——基础版 1000 积分、标准版 2000 积分、专业版 4000 积分、旗舰版 7000 积分。内测期套餐切换即时生效、无需付费。",
  },
  {
    q: "写好的小说能导出吗？",
